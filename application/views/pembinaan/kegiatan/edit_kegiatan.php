                ...
                <div class="col-md-6">
                  <form action="<?= site_url('kegiatan/edit_data/' . $kegiatan->id_kegiatan) ?>" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="nama_kegiatan" id="nama" value="<?= $kegiatan->nama_kegiatan ?>" class="form-control <?= form_error('nama_kegiatan') ? 'is-invalid' : ''; ?>">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group date" id="tglmulai" data-target-input="nearest">
                        <input type="text" name="tgl_mulai" value="<?= $kegiatan->tgl_mulai ?>" class="form-control datetimepicker-input <?= form_error('tgl_mulai') ? 'is-invalid' : ''; ?>" data-target="#tglmulai"/>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group date" id="tglberakhir" data-target-input="nearest">
                        <input type="text" name="tgl_berakhir" value="<?= $kegiatan->tgl_berakhir ?>" class="form-control datetimepicker-input <?= form_error('tgl_berakhir') ? 'is-invalid' : ''; ?>" data-target="#tglberakhir"/>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="kuota_peserta" id="kuota" value="<?= $kegiatan->kuota ?>" class="form-control <?= form_error('kuota_peserta') ? 'is-invalid' : ''; ?>">
                      <div class="invalid-feedback"><?= form_error('kuota_peserta'); ?></div>
                    </div>
                    <div class="form-group">
                      <label for="keterangan">Keterangan</label>
                      <textarea name="keterangan" id="keterangan" rows="3" class="form-control <?= form_error('keterangan') ? 'is-invalid' : ''; ?>"><?= $kegiatan->keterangan ?></textarea>
