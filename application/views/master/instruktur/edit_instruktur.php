                ...
                <div class="col-md-6">
                  <form action="<?=site_url('instruktur/edit_data/' . $instruktur->id_instruktur)?>" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="telp" id="telp" value="<?=$instruktur->telp?>" class="form-control" required>
                    </div>
                    <div class="form-group">
                      <label for="email">Email *</label>
                      <input type="email" name="email" id="email" value="<?=$instruktur->email?>" class="form-control" required>
                    </div>
                    <div class="form-group">
                      <label for="alamat">Alamat *</label>
                      <textarea name="alamat" id="alamat" rows="3" class="form-control" required><?=$instruktur->alamat?></textarea>
                    </div>
                    <div class="form-group">
